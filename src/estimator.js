...
const covid19ImpactEstimator = (data) => ({
  ...
  impact: {
    ...
    casesForVentilatorsByRequestedTime: Math.trunc(0.02 * Math.trunc(normalCases(data))),
  ...
  severeImpact: {
    ...
    casesForVentilatorsByRequestedTime: Math.trunc(0.02 * Math.trunc(severeCases(data))),
